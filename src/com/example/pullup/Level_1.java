...
public class Level_1 extends Activity {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			Intent intent2 = new Intent(Level_1.this, Main.class);
			finish();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		level.setBackgroundResource(R.drawable.step1_1);
		
		int p = getIntent().getIntExtra("page", 1);
		if (p==2) {level.setBackgroundResource(R.drawable.step1_1);}
		if (p==3) {level.setBackgroundResource(R.drawable.step1_1);}
		if (p==4) {level.setBackgroundResource(R.drawable.step1_1);}   
	    ...
	    public void onClick(View v) {
			...
			if (p==2) 
				{Intent intent1 = new Intent(Level_1.this, Timer.class);
				intent1.putExtra("timer", t=2);
				finish();
